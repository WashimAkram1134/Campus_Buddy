            ...
            <div class="clubs-hero-container">
                <div class="clubs-hero-left">
                    ...
                    <p class="reveal" style="transition-delay: 0.2s;">
                        Discover organizations that match your passions, build your skills, and connect you with lifelong friends. From robotics to debate, there's a space for everyone.
                    </p>
                ...
                <div class="clubs-hero-right reveal" style="transition-delay: 0.4s;">
                    <div class="clubs-hero-image-wrap floating">
                        ...
                        <img src="{{ asset('images/community/studygroup.jpg') }}" alt="Students at a Club" class="clubs-hero-img">
                    </div>
            ...
            <div class="clubs-grid">
                ...
                <div class="club-card reveal" data-category="tech">
                    <div class="club-banner">
                        ...
                        <img src="{{ asset('images/community/event.jpg') }}" alt="Computer Club">
                    ...
                    <div class="club-body">
                        ...
                        <div class="club-info">
                            ...
                            <p>Join us to solve algorithmic challenges, build open-source projects, and prepare for competitive programming contests.</p>
                        </div>
                        <div class="club-meta">
                            <div class="meta-item">
                ...
                <div class="club-card reveal" data-category="arts" style="transition-delay: 0.1s;">
                    <div class="club-banner">
                        <img src="{{ asset('images/community/workshop.jpg') }}" alt="Drama Club">
                    ...
                    <div class="club-body">
                        ...
                        <div class="club-info">
                            ...
                            <p>Express yourself on stage! We regularly host plays, improve sessions, and actings workshops for all levels.</p>
                        </div>
                        <div class="club-meta">
                            <div class="meta-item">
                ...
                <div class="club-card reveal" data-category="academic" style="transition-delay: 0.2s;">
                    <div class="club-banner">
                        <img src="{{ asset('images/community/post.jpg') }}" alt="Debate Club">
                    ...
                    <div class="club-body">
                        ...
                        <div class="club-info">
                            ...
                            <p>Enhance your public speaking and critical thinking skills. We participate in national and international tournaments.</p>
                        </div>
                        <div class="club-meta">
                            <div class="meta-item">
                ...
                <div class="club-card reveal" data-category="sports">
                    <div class="club-banner">
                        <img src="{{ asset('images/community/event.jpg') }}" alt="Sports Club">
                    ...
                    <div class="club-body">
                        ...
                        <div class="club-info">
                            ...
                            <p>From soccer to basketball, join our community of student athletes to stay fit and compete.</p>
                        </div>
                        <div class="club-meta">
                            <div class="meta-item">
                ...
                <div class="club-card reveal" data-category="tech" style="transition-delay: 0.1s;">
                    <div class="club-banner">
                        <img src="{{ asset('images/community/studygroup.jpg') }}" alt="Robotics">
                        <span class="club-category">Technology</span>
                    </div>
                    <div class="club-body">
                        <div class="club-logo">🤖</div>
                        <div class="club-info">
                            ...
                            <p>Building the future with hardware and software. We design autonomous bots, drones, and IoT systems.</p>
                        </div>
                        <div class="club-meta">
                            <div class="meta-item">
                ...
                <div class="club-card reveal" data-category="arts" style="transition-delay: 0.2s;">
                    <div class="club-banner">
                        <img src="{{ asset('images/community/workshop.jpg') }}" alt="Photography">
                        <span class="club-category">Arts</span>
                    </div>
                    <div class="club-body">
                        <div class="club-logo">📷</div>
                        <div class="club-info">
                            ...
                            <p>Capture the moments that matter. Join our monthly photo-walks and exhibition events.</p>
                        </div>
                        <div class="club-meta">
                            <div class="meta-item">
        ...
        <section id="create-club" class="create-club-banner reveal">
            <div class="cc-container">
                ...
                <div class="cc-content">
                    ...
                    <p>Start a new student organization! Gather at least 10 members, draft a charter, and apply to become an officially recognized campus club.</p>
                </div>
                <div class="cc-action">
