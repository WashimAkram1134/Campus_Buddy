...
<body
    class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 pt-[100px] lg:pt-[100px] items-center lg:justify-center min-h-screen flex-col">
    @include('includes.menu')

    <div
        class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0 mt-8">
