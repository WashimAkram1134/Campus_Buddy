...
@php
    ...
    // Page groups for visibility logic
    $isAuthPage = in_array($currentRoute, ['login', 'signup', 'password.request', 'password.reset.form', 'password.reset.update']);
    ...
    // Only fetch data if we're on a page that actually shows it (not Landing or Auth)
