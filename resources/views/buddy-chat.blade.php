      ...
      <main class="chat-main" id="chatMain">
        ...
        <div class="chat-top-header">
          ...
          <div class="chat-top-actions">
            ...
            <!-- Dropdown Menu -->
            <div class="chat-options-dropdown" id="optionsDropdown">
              <button class="chat-option-item" id="focusModeBtn">
        ...
        <div class="chat-input-area">
          <div class="input-wrapper" id="inputWrapper">
            <textarea id="chatInput" class="chat-input" placeholder="Ask Buddy anything about campus life…" rows="1"
          ...
          <p class="input-hint">Buddy AI can make mistakes. Verify important information. Press <kbd>Enter</kbd> to
            send, <kbd>Shift+Enter</kbd> for new line.</p>
        </div>
        ...
        <div>
          ...
          <div class="topic-chips">
            ...
            <button class="topic-chip"
              onclick="sendQuickMessage('What internships are available?')">Internships</button>
