          ...
          <div class="schedule-timeline" id="routineTimeline">
            ...
            <div class="day-group active" id="group-monday">
              ...
              <div class="class-card">
                <div class="class-time"><span class="time-start">09:00 AM</span><span class="time-end">10:30 AM</span>
                </div>
              ...
              <div class="class-card">
                <div class="class-time"><span class="time-start">11:00 AM</span><span class="time-end">12:30 PM</span>
                </div>
                <div class="class-details">
            ...
            <div class="day-group" id="group-wednesday">
              ...
              <div class="class-card">
                <div class="class-time"><span class="time-start">08:00 AM</span><span class="time-end">09:30 AM</span>
                </div>
                <div class="class-details">
            ...
            <div class="day-group" id="group-saturday">
              ...
              <div class="class-card">
                <div class="class-time"><span class="time-start">10:00 AM</span><span class="time-end">01:00 PM</span>
                </div>
                <div class="class-details">
            ...
            <div class="day-group" id="group-sunday">
              ...
              <div class="class-card">
                <div class="class-time"><span class="time-start">09:00 AM</span><span class="time-end">11:00 AM</span>
                </div>
                <div class="class-details">
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>
                    <div class="table-class">Operating Systems<br><span>Room 205</span></div>
                  </td>
                  <td class="off-day">Off Day</td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>
                    <div class="table-class">Data Structures<br><span>Room 713</span></div>
                  </td>
                  <td class="off-day">Off Day</td>
                  <td></td>
                  <td></td>
                ...
                <tr>
                  ...
                  <td class="off-day">Off Day</td>
                  <td>
                    <div class="table-class">DBMS<br><span>Room 301</span></div>
                  </td>
                  <td></td>
                  <td class="off-day">Off Day</td>
                  <td rowspan="2">
                    <div class="table-class">AI Hackathon Prep<br><span>Auditorium</span></div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td></td>
                  <td>
                    <div class="table-class highlight">Machine Learning<br><span>CSE Lab 2</span></div>
                  </td>
                  <td class="off-day">Off Day</td>
                  <td></td>
                  <td></td>
