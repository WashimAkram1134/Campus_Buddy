...
<body>
    ...
    <main class="main">
      ...
      <section class="district-section" id="district-section">
          ...
          <div class="map-wrapper">
            <svg xml:space="preserve" enable-background="new 0 0 1550.242 2149.604" viewBox="0 0 1550.242 2149.604"
              ...
              <g id="Rangpur" class="division">
                ...
                <text x="350" y="250" font-size="60" fill="black" font-weight="bold"
              ...
              <g id="Rajshahi" class="division">
                ...
                <text x="350" y="850" font-size="60" fill="black" font-weight="bold"
              ...
              <g id="Khulna" class="division">
                ...
                <text x="350" y="1450" font-size="60" fill="black" font-weight="bold"
              ...
              <g id="Barisal" class="division">
                ...
                <text x="700" y="1450" font-size="60" fill="black" font-weight="bold"
              ...
              <g id="Chittagong" class="division">
                ...
                <text x="1100" y="1150" font-size="60" fill="black" font-weight="bold"
              ...
              <g id="Sylhet" class="division">
                ...
                <text x="1100" y="550" font-size="60" fill="black" font-weight="bold"
              ...
              <g id="Mymensingh" class="division">
                ...
                <text x="750" y="550" font-size="60" fill="black" font-weight="bold"
              ...
              <g id="Dhaka" class="division">
                ...
                <text x="700" y="1050" font-size="60" fill="black" font-weight="bold" pointer-events="none">Dhaka</text>
              </g>
            </svg>
          </div>
        </div>
        ...
        <div style="text-align: center; margin-top: 30px;">
          <button id="view-more-districts" class="view-more" style="display: none;">View More Associations</button>
        </div>
      </section>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const viewMoreBtn = document.getElementById('view-more-districts');
      ...
      divisions.forEach(div => {
        div.addEventListener('click', function () {
          ...
          viewMoreBtn.style.display = 'none'; // Hide view more when filtering
